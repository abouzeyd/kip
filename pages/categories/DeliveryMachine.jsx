...
import img1 from '../assets/images/electric-iron-6046-1920-4@1x.png';
import img2 from '../assets/images/ruler-2099742-1920-3@1x.png';
import img3 from '../assets/images/ruler-2099742-1920-4@1x.png';
import img4 from '../assets/images/ruler-2099742-1920-5@1x.png';
...
const DeliveryMachine = () => {
  return (
    ...
    >
      <div sx={{ pt: 12, mt: 32 }}>
        <Card sx={{ width: 450, height: 550, pt: 12 }}>
          <span
            sx={{
              fontSize: '12px',
              ml: 12,
      ...
      <div sx={{ width: '1px', pt: 39, mr: 150 }}>
        APPAREILS ELECTROMANAGERS
      </div>
    </div>
  );
};
